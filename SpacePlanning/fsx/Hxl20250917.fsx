    ...
    let div = match Array.length pty > Array.length flt with
                | true -> 
                            ...
                            let cnk2 = match Array.length cnk1 > Array.length flt with
                                        | true -> Array.append (Array.take (Array.length flt - 1) cnk1) [|Array.concat cnk1.[Array.length cnk1 - 2 ..]|]
                                        | false -> cnk1
                            let a = Array.mapi (fun i x -> cnk2.[i] |> Array.map (fun y -> (x, y))) flt
                ...
                | false -> 
                            ...
                            let cnk2 = match Array.length cnk1 > Array.length pty with
                                        | true -> Array.append (Array.take (Array.length pty - 1) cnk1) [|Array.concat cnk1.[Array.length cnk1 - 2 ..]|]
                                        | false -> cnk1
...
let sq = HRCCNE
let st = hxlVld sq (AV(12,-7,0))
let en = hxlVld sq (AV(-2,5,0))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
