    ...
    let inc (hxl : (int * Hxl)[]) (occ : Hxl[]) = 
        ...
        let hx4 = match ((hx3|>Array.length) > 1) with 
                    | false -> hx3
                    | true -> 
                                match (ct2 |> Array.last) with 
                                | 0 -> 
                                        let hx51 = hx3 |> Array.rev |> Array.tail |> Array.rev
                                        let hx52 = [|hx1 |> Array.last|]
                                        [|hx51;hx52|] |> Array.concat
                                | _ -> 
                                        let hx41 = hx3 |> Array.rev |> Array.tail |> Array.rev
                                        let hx42 = hx1 |> Array.last |> adj
                                        let hx43 = exc ([|oc1;hx41|] |> Array.concat) hx42
                                        let hx44 = [|hx43 |> Array.head|]
                                        [|hx41;hx44|] |> Array.concat
